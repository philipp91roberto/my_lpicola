...
#endif
// Now the condition LOCAL_FNL is closed

// Compute displacements using nongaussian potential
// ================================================
#endif
// Now the condition GENERIC_FNL is closed
...
#endif
  // Now the condition GAUSSIAN is closed
...
#ifdef POTENTIAL
#ifdef MEMORY_MODE
  iGPot = (float *)malloc(NumPart*sizeof(float));
#endif
#else
  iGPot = (float_kind *)malloc(NumPart*sizeof(float_kind));
#endif
