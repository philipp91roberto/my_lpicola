...
float_kind * PotM;        // The gravitational potential on the grid for the output
#endif
float_kind * mPot;        // The gravitational potential grid
complex_kind * cmPot;     // Pointer to the complex, FFT'ed gravitational potential grid (use in-place FFT)
plan_kind pmPot;          // The plan for the in-place FFT of the gravitational potential grid
#endif
...
struct io_header_PotM header_PotM;
#endif
...
#ifdef POTENTIAL
float * iGPot;		// Scalar to hold the gravitational potential before particle initialisation
#endif
#else
...
#ifdef POTENTIAL
float_kind * iGPot;		 // Scalar to hold the gravitational potential before particle initialisation
#endif
#endif
struct part_data * P;
